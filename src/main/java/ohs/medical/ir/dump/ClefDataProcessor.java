...
public class ClefDataProcessor {
	...
	public static void removeMarkups() {
		...
		TextFileWriter writer = new TextFileWriter(MIRPath.CLEF_EHEALTH_COLLECTION_FILE);

		int totalDocs = 0;

		List<File> inputFiles = IOUtils.getFilesUnder(MIRPath.CLEF_EHEALTH_COLLECTION_DIR);
	...
	public static void splitSentences() {
		...
		TextFileWriter writer = new TextFileWriter(MIRPath.CLEF_EHEALTH_COLLECTION_FILE_2);
