...
public abstract class SPUDLMBaseSimilarity extends SimilarityBase {
	...
	public static interface CollectionModel {
		...
		/**
		 * Computes the probability {@code p(w|C)} according to the language model strategy for the current term.
		 */
	...
	/**
	 * Models {@code p(w|C)} as the number of occurrences of the term in the collection, divided by the total number of tokens {@code + 1}.
	 */
	...
	/**
	 * 079 Returns the name of the LM method. The values of the parameters should be 080 included as well. 081 Used in {@link #toString()}.
	 * 082
	 */
	...
	/**
	 * 086 Returns the name of the LM method. If a custom collection model strategy is 087 used, its name is included as well. 088
	 *
	 * @see #getName() 089
